...
import { Building, ResidentialBuilding, CommercialBuilding, UtilityBuilding } from '../src/main';
...
describe("Building Class:", function() {
    ...
    it(`should return "Building Compconsted on ${building.builtDate}." for getBuiltDate()`, () => {
        assert.equal(building.getBuiltDate(),`Building Compconsted on ${building.builtDate}.`);
    });   
